...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_model', default='../Code_USOD10K/pretrained_model/80.7_T2T_ViT_t_14.pth.tar', type=str, help='load pretrained model')
    ...
    parser.add_argument('--trainset', default='../Code_USOD10K/data/USOD10K/USOD10K_TR', type=str, help='Trainging set')
    ...
    parser.add_argument('--test_paths', type=str, default='../Code_USOD10K/data/USOD10K/USOD10K_TE')
